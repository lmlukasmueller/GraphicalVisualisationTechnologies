var app = ( function() {
	...
	function initModels() {
		...
		createModel("plane", fs,  [0, -2, 0], [0, 0, 0], [4, 4, 4]);
		createModel("torus1", fs, [0, 0.5, 3], [0, 0, 0], [2, 2, 2]);
		createModel("torus1", fs, [1, 0, 3], [0, 1.4, 0], [2.5, 2.5, 2.5]);
		createModel("torus1", fs, [-1, 0, 3], [0, -1.4, 0], [2.5, 2.5, 2.5]);
		createModel("sphere1", fs, [0, -1.5, 0], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, -1.2, 0.5], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, -0.9, 1], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, -0.6, 1.5], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, -0.3, 2], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, -0, 2.5], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, 0.5, 3], [0, 0, 0], [0.2, 0.2, 0.2]);
		createModel("sphere1", fs, [0, 0.8, 3.5], [0, 0, 0], [0.5, 0.5, 0.5]);
		createModel("sphere1", fs, [0, 0.9, 4], [0, 0, 0], [0.5, 0.5, 0.5]);
