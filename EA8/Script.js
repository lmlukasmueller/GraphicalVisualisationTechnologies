var app = (function() {
    ...
    var illumination = {
        ambientLight : [ .6, .6, .6 ],
        light : [
			{isOn:true, position:[3.,0,1], color:[1.2,.5,.5]},
			{isOn:true, position:[-4.,1.,1], color:[0,.2,0.8]},	
    ...
    function createPhongMaterial(material) {
        ...
        material.ka = material.ka || [ 0.2, 0.2, 0.2 ];
        material.kd = material.kd || [ 0.3, 0.3, 0.3 ];
        material.ks = material.ks || [ 0.7, 0.7, 0.7 ];
    ...
    function initModels() {
        ...
        createModel("torus", fs, [ 1, 1, 2, 2 ], [ 0, .75, 2 ],
                [ 0, 0, 0, 0 ], [ 1, 1, 1, 1 ], mDefault);
        createModel("sphere", fs, [ 1, 1, 2, 2 ], [ -1.25, .5, 2 ], [ 0, 0,
                0, 0 ], [ .5, .5, .5 ], mDefault);
        createModel("sphere", fs, [ 1, 1, 2, 2 ], [ 1.25, .5, 2 ], [ 0, 0,
                0, 0 ], [ .5, .5, .5 ], mDefault);
        createModel("plane", fs, [ 1, 1, 2, 1 ], [ 0, 0, 0, 0 ], [ 0, 0, 0,
                0 ], [ 2, 2, 2, 2 ], mDefault);
